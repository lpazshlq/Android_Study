    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_homework01:
                intent.setAction("com.lei.action.lesson08_homework01");
                startActivity(intent);
                break;
            case R.id.btn_homework02:
                intent.setAction("com.lei.action.lesson08_homework02");
                startActivity(intent);
                break;
            case R.id.btn_homework03:
                intent.setAction("com.lei.action.lesson08_homework03");
                startActivity(intent);
                break;
        }
    }
